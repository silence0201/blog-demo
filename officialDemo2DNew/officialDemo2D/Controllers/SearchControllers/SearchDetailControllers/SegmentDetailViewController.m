...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            case 0: subTitle = [NSString stringWithFormat:@"%d 米", @(self.segment.walking.distance).intValue]; break;
            case 1: subTitle = [NSString stringWithFormat:@"%d 米", @(self.segment.taxi.distance).intValue]; break;
